...
func main() {
	...
	//listIngresses(dynamicClient)
	//listDep(dynamicClient)
	//listServices(dynamicClient)
	//listDeployments(dynamicClient)
	...
	//getServiceInvokeUrl(dynamicClient, "istio-system", "istio-ingressgateway")
	//getServiceInvokeUrl(dynamicClient, "default", "gateway-istio-customer")
}
...
func listDep(client dynamic.Interface) error {
	...
	result, getErr := client.Resource(deploymentRes).Namespace("default").Get(context.TODO(), "demo-deployment", metav1.GetOptions{})
	if getErr != nil {
	...
	//  Apply the patch to the 'service2' service.
	vs, err := client.Resource(deploymentRes).Namespace("default").Patch(context.TODO(), "demo-deployment", types.JSONPatchType, b, metav1.PatchOptions{})
	log.Print(vs)
	if err != nil {
		log.Print(err)
	}
...
func listDeployment(client dynamic.Interface) error {
	//  Create a GVR which represents an Istio Virtual Service.
...
func listServices(client dynamic.Interface) error {
	//  Create a GVR which represents an Istio Virtual Service.
	gvr := schema.GroupVersionResource{
		Group:    "",
		Version:  "v1",
...
func listIngresses(client dynamic.Interface) error {
	//  Create a GVR which represents an Istio Virtual Service.
	gvr := schema.GroupVersionResource{
...
func addNewMsRouteToVs(client dynamic.Interface, ns string, vsname string, uriName string, uriPrefix string, uriRewrite string, host string, port int32) {
	//  Create a GVR which represents an Istio Virtual Service.
	gvr := schema.GroupVersionResource{
		Group:    "networking.istio.io",
		Version:  "v1alpha3",
	...
	res, err := client.Resource(gvr).Namespace("default").Get(context.TODO(), vsname, metav1.GetOptions{})
	log.Print(res)
	if err != nil {
		log.Print(err)
	}
	...
	//  Apply the patch to the 'service2' service.
	vs, err := client.Resource(gvr).Namespace("default").Patch(context.TODO(), vsname, types.JSONPatchType, b, metav1.PatchOptions{})
	log.Print(vs)
	if err != nil {
		log.Print(err)
	}
...
func getServiceInvokeUrl(client dynamic.Interface, ns string, vsname string) {
	//  Create a GVR which represents an Istio Virtual Service.
	/*
		gvr := schema.GroupVersionResource{
			Group:    "networking.istio.io",
			...
			res, err := client.Resource(gvr).Namespace(ns).List(context.TODO(), metav1.ListOptions{})
			//log.Print(res.spec.servers.port[0].number)
			if err != nil {
				log.Print(err)
			}
	*/

	//data, _, _ := unstructured.NestedString(res.Object, "spec", "selector", "istio")
	...
	/*
		...
		res, err := client.Resource(gvr).Namespace(ns).Get(context.TODO(), vsname, metav1.GetOptions{})
		log.Print(res)
		if err != nil {
			log.Print(err)
		}
...
// Use swagger instead!!
func appendMsRouteToVs(client dynamic.Interface, ns string, vsname string, uriName string, uriPrefix string, uriRewrite string, host string, port int32) {
	//  Create a GVR which represents an Istio Virtual Service.
	gvr := schema.GroupVersionResource{
		Group:    "networking.istio.io",
		Version:  "v1alpha3",
...
func addCircuitBrakerToDr(client dynamic.Interface) error {
	//  Create a GVR which represents an Istio Virtual Service.
	gvr := schema.GroupVersionResource{
		Group:    "networking.istio.io",
		Version:  "v1alpha3",
	...
	res, err := client.Resource(gvr).Namespace("default").Get(context.TODO(), "vs-test", metav1.GetOptions{})
	log.Print(res)
	if err != nil {
		log.Print(err)
	}
	...
	//  Apply the patch to the 'service2' service.
	vs, err := client.Resource(gvr).Namespace("default").Patch(context.TODO(), "vs-test", types.JSONPatchType, b, metav1.PatchOptions{})
	log.Print(vs)
	if err != nil {
		log.Print(err)
	}
